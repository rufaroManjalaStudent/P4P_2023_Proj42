...
rho = 1.225;
d_wtrated = 3.0337; d_wt = 0.9688; d_wg = 0.9688; d_Tg = d_wg; %Feel like d_wg in fact should also be d_Tg
d_bl = 40.05; d_Lambda = 8.1; fs = 50; d_ws = 2*pi*fs; %fs and wsadded to simulation, fs is in hertz
d_Beta = 0; d_vw = 14.5316; d_Ts = 0.9385;  d_base = 5; d_welb = (2*pi*50); %d_base was added by Rufaro as was undefined
